...
class AgentUser extends BaseModel
{
    ...
    {
        return $this->belongsTo('app\\common\\model\\plus\\supply\\Supply', 'shop_user_id', 'shop_user_id');
    }
    ...
    public function loginState($user)
    {
        ...
        $session = array(
            ...
            'app' => $app->toArray(),
            'supply_id'=>empty($supply['supply_id'])?0:$supply['supply_id'],
            'is_login' => true,
        );
        session('kmdshop_agent', $session);
    }
}